                ...
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            ...
                            <li>
                                <a href="/blog" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Blog </a>
                            </li>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            <li>
                                <a href={`services/${1}`} title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Family-Based Immigration Visas </a>
                            </li>

                            <li>
                                <a href={`services/${2}`} title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Employment-Based Immigration Visas </a>
                            </li>

                            <li>
                                <a href={`services/${3}`} title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Diversity Visa Program </a>
                            </li>

                            <li>
                                <a href={`services/${4}`} title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Family-Based Immigration Visas </a>
                            </li>
                            <li>
                                <a href={`services/${5}`} title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Family-Based Immigration Visas </a>
                            </li>
                        </ul>
                    </div>

                    <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Follow us on</p>
                        ...
                        <section>
              {/* <div className='text-gray-400 uppercase text-2xl md:text-3xl font-mono font-bold'>Follow Us On</div> */}
              <div className='lg:flex flex-row justify-center gap-3 m-6' id="contactarea">
