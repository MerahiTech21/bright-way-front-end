  ...
  function closeModal() {
    ...
    <div className="lg:w-3/5 lg:ps-20 p-10">              
        ...
        <div className="flex mt-8 pb-10 lg:pb-0">
            <button onClick={()=>setIsOpen(true)} className="px-4 py-2 mr-4 bg-dark-gray uppercase  text-black  rounded-lg text-md hover:bg-indigo-200">
                YOUR APPLICATION STATUS
            </button>
            <Link href="/programs" className="px-4 py-2 text-white bg-primary uppercase rounded-lg dark:text-white hover:bg-indigo-200 hover:text-primary text-md">
                Find Programs
            </Link>
        </div>
    </div>
