 ...
 const AboutPage = () => {
  return (
      <div className='min-h-screen'>
        <div className='bg-primary-green-dark md:grid md:grid-cols-2 md:gap-4 pb-5 w-full lg:min-h-full lg:pb-20 lg:mx-auto text-slate-900'>
          <div>
            <Section>
              <div className='text-center pt-10 text-3xl text-white'>About Bright way Education consultancy</div>
            </Section>
            <Section>
              {/* <div className='md:pe-20 pt-5 text-white'>            
                  <p>
        ...
        <WhyChooseUs />
        <div className='bg-primary-green text-4xl lg:mt-5 my-10 pb-10'>
          <Section>
