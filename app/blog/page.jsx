  ...
  return (
    <div className="bg-light py-24 sm:py-32">
      <div className="px-6 lg:px-8">
        ...
        <Section>
          <h2 className="text-center text-3xl font-bold sm:text-4xl font-mono">Our Supportive blogs</h2>          
          <p className="mt-2 text-lg text-center text-primary leading-8  font-mono">
