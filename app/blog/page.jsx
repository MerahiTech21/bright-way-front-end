    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          {posts.map((post) => (
            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between overflow-hidden rounded-lg shadow-lg cursor-pointer pb-5">
            <Image src='/blogimg.jpeg' alt="" width={500} height={300} className="w-full bg-gray-50" />
              ...
              <div className="relative mt-8 flex items-center gap-x-4 px-5">
